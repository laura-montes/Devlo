...
namespace Proyecto_DAM.Classes
{
    class Product
    {
        private int code, category, supplier, stock;
        ...
        public Product(int code, int category, int supplier, int stock, string name, string description, double sell_price, double supplier_price)
        {
            this.Code = code;
