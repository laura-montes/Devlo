...
namespace Control
{
    ...
    public partial class db_devloEntities : DbContext
    {
        ...
        public virtual int PA_ADD_SALE_CAB(Nullable<int> iDCONTACT, Nullable<decimal> tOTAL_PRICE, string cOMENTS, Nullable<int> iNVOKER, string uSUARIO, string cULTURA, ObjectParameter rETCODE, ObjectParameter mENSAJE, ObjectParameter iDCAB)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PA_ADD_SALE_CAB", iDCONTACTParameter, tOTAL_PRICEParameter, cOMENTSParameter, iNVOKERParameter, uSUARIOParameter, cULTURAParameter, rETCODE, mENSAJE, iDCAB);
        }
