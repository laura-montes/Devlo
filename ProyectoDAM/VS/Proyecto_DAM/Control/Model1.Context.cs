...
namespace Control
{
    ...
    public partial class db_devloEntities : DbContext
    {
        ...
        public virtual int PA_ADD_USER(string nAME, string sURNAMES, string eMAIL, string pASSWORD, string rOLE, Nullable<int> iNVOKER, string uSUARIO, string cULTURA, ObjectParameter rETCODE, ObjectParameter mENSAJE)
        {
            var nAMEParameter = nAME != null ?
                new ObjectParameter("NAME", nAME) :
                new ObjectParameter("NAME", typeof(string));
        ...
        public virtual int PA_RECOVER_PASSWORD(string nAME, string eMAIL, Nullable<int> iNVOKER, string uSUARIO, string cULTURA, ObjectParameter rETCODE, ObjectParameter mENSAJE, ObjectParameter pASSWORD)
        {
            var nAMEParameter = nAME != null ?
                new ObjectParameter("NAME", nAME) :
                new ObjectParameter("NAME", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PA_RECOVER_PASSWORD", nAMEParameter, eMAILParameter, iNVOKERParameter, uSUARIOParameter, cULTURAParameter, rETCODE, mENSAJE, pASSWORD);
        }
    }
}
